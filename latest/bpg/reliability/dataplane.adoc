...
link:eks/latest/userguide/automode.html[EKS Auto Mode managed nodes,type="documentation"], 
link:eks/latest/userguide/worker.html[EC2 Instances,type="documentation"] and
link:eks/latest/userguide/fargate.html[Fargate,type="documentation"].
...
managed node groups,type="documentation"]. You can have a cluster with a mix of Auto Mode, managed,
...
link:eks/latest/userguide/horizontal-pod-autoscaler.html[horizontal
pod autoscaler,type="documentation"].
...
link:autoscaling/ec2/userguide/AutoScalingGroup.html[EC2
Auto Scaling groups,type="documentation"].
...
the link:eks/latest/userguide/ebs-csi.html[EBS CSI,type="documentation"] will also need to be installed.
...
the configured link:eks/latest/userguide/create-node-pool.html#_disruption[NodePool,type="documentation"]
disruption settings and Pod Disruption Budgets.

=== Run the Node Monitoring Agent

The link:eks/latest/userguide/node-health.html[Node Monitoring Agent,type="documentation"] monitors
...
enabling the built-in link:eks/latest/userguide/coredns-autoscaling.html[auto-scaling of CoreDNS Pods,type="documentation"]. 
