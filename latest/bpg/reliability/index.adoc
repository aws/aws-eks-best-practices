...
you, the customer, and AWS. EKS offers three options for Kubernetes data
...
image::reliability_SRM-Fargate.jpeg[Shared Responsibility Model - Fargate]

.Shared Responsibility Model - MNG
image::reliability_SRM-MNG.jpeg[Shared Responsibility Model - MNG]
