...
If you are utilizing [EKS Auto Mode](https://docs.aws.amazon.com/eks/latest/userguide/automode.html) 
the AWS Load Balancer comes pre-installed on your cluster.
...
📝 https://github.com/aws/aws-eks-best-practices/tree/master/latest/bpg/networking/loadbalancing.adoc[Edit this page on GitHub]