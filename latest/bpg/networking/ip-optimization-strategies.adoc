...
You can also set link:AmazonCloudWatch/latest/monitoring/AlarmThatSendsEmail.html[CloudWatch alarms,type="documentation"] to get notified if a subnet is running out of IP addresses.
