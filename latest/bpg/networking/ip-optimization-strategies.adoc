...
Assosiate new CIDR block to your VPC
Create new Subnet in the new CIDR block and tag it with "kubernetes.io/role/cni" = "1"
Enable Set "ENABLE_SUBNET_DISCOVERY” VPI CNI add-on configuration to “true” (Default since version 1.18.0)
...
image::opt_enhanced-subnet-discovery.png[Enhanced Subnet Discovery, traffic flow]
