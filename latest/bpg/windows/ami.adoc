...
*NOTE:* Prior to selecting a base image, consult the xref:licensing.adoc[Windows Server Version and License] section for important details pertaining to release channel updates.
