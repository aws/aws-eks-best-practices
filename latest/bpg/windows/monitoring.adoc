...
:info_titleabbrev: Monitoring Windows Containers
...
image::prom.png[Prometheus Metrics collection]
...
📝 https://github.com/aws/aws-eks-best-practices/tree/master/latest/bpg/windows/monitoring.adoc[Edit this page on GitHub]