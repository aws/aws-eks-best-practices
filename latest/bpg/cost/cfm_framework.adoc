 ...
 ** Use link:eks/latest/userguide/eks-using-tags.html#tag-resources-for-billing[Instance Tagging,type="documentation"], tagging EKS clusters allows you to see individual cluster costs and allocate them in your Cost & Usage Reports.
