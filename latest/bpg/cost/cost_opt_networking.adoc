//!!NODE_ROOT <section>
[."topic"]
[[cost-opt-networking,cost-opt-networking.title]]
...
image::../images/topo_aware_routing.png[Topology aware routing]
...
image::../images/endpoint_slice.png[Endpoint Slice]
...
image::../images/slice_shell.png[Slice shell]
...
image::../images/local_traffic.png[Local internal traffic]
...
image::../images/no_node_local_1.png[node-local_no_peer]
...
image::../images/no_node_local_2.png[node-local_with_peer]
...
image::../images/lb_2_pod.png[LB to Pod]
...
image::../images/ip_mode.png[IP mode]
...
image::../images/nat_gw.png[NAT Gateway]
...
image::../images/recommended_approach.png[Recommended approach]
...
image::../images/between_vpcs.png[Between VPCs]
...
image::../images/peering.png[Peering]
...
image::../images/transititive.png[Transitive]
