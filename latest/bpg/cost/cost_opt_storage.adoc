...
For a deep dive on monitoring, please refer to the https://docs.aws.amazon.com/eks/latest/best-practices/cost-opt-observability.html[EKS cost optimization observability guide].
