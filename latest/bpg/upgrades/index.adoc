...
https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/#install-kubectl-convert-plugin[conversion
...
https://karpenter.sh/docs/concepts/disruption/[Disruption]
...
https://karpenter.sh/docs/concepts/disruption/#drift[Karpenter's
...
https://karpenter.sh/docs/reference/settings/#feature-gates[feature
...
https://docs.aws.amazon.com/eks/latest/eksctl/managing-nodegroups.html[deleting
and draining self-managed nodes.]

Some common tools include:

* https://docs.aws.amazon.com/eks/latest/eksctl/nodegroup-upgrade.html[eksctl]
* https://kops.sigs.k8s.io/operations/updates_and_upgrades/[kOps]
* https://github.com/aws-ia/terraform-aws-eks-blueprints[EKS
Blueprints]
...
link:eks/latest/userguide/integration-backup.html[AWS Backup,type="documentation"],
a fully managed service. You can also use https://velero.io/[Velero], a
...
AWS resources, including IAM, are not included in the backup. These
resources would need to be recreated.
