...
link:eks/latest/userguide/kubernetes-versions.html[Amazon
EKS Kubernetes versions,type="documentation"] to understand any possible impact to your
...
link:eks/latest/userguide/managing-add-ons.html#updating-an-add-on[Updating
an add-on,type="documentation"] to understand the compatibility of any existing cluster
add-ons with the cluster version you intend to upgrade to.
* *Enable Control Plane Logging* — Enable
link:eks/latest/userguide/control-plane-logs.html[control
plane logging,type="documentation"] to capture logs, errors, or issues that can arise during
...
automate worker node upgrades by using link:eks/latest/userguide/automode.html[Auto Mode,type="documentation"] or 
link:eks/latest/userguide/managed-node-groups.html[EKS
managed node groups,type="documentation"]. These options simplify the process and reduce manual
intervention.
...
link:eks/latest/userguide/kubernetes-versions.html#kubernetes-release-calendar[Review
the EKS Kubernetes release calendar,type="documentation"] to learn when new versions are
...
link:eks/latest/userguide/update-cluster.html[Learn
how to initiate an upgrade.,type="documentation"] When you initiate a cluster upgrade, AWS
...
. link:eks/latest/userguide/update-cluster.html[Upgrade
the cluster control plane using the AWS console or cli.,type="documentation"]
. xref:upgrade-addons[Review
add-on compatibility.] Upgrade your Kubernetes add-ons and custom
controllers, as required.
. link:eks/latest/userguide/install-kubectl.html[Update
kubectl.,type="documentation"]
. link:eks/latest/userguide/update-managed-node-group.html[Upgrade
the cluster data plane.,type="documentation"] Upgrade your nodes to the same Kubernetes minor
...
The EKS Kubernetes
link:eks/latest/userguide/kubernetes-versions.html[version
documentation,type="documentation"] includes a detailed list of changes for each version.
...
(e.g. link:eks/latest/userguide/ebs-csi.html[EBS
CSI,type="documentation"], link:eks/latest/userguide/efs-csi.html[EFS
CSI,type="documentation"]), ingress controllers, and any other workloads or add-ons that rely
...
link:eks/latest/userguide/managing-vpc-cni.html[Updating
the Amazon VPC CNI plugin for Kubernetes self-managed add-on,type="documentation"]. *When
installed as an Amazon EKS Add-on, it can only be upgraded one minor
version at a time.*
* *kube-proxy:* See
link:eks/latest/userguide/managing-kube-proxy.html[Updating
the Kubernetes kube-proxy self-managed add-on,type="documentation"].
* *CoreDNS:* See
link:eks/latest/userguide/managing-coredns.html[Updating
the CoreDNS self-managed add-on,type="documentation"].
...
link:eks/latest/userguide/aws-load-balancer-controller.html[installation
guide,type="documentation"] for more information.
* *Amazon Elastic Block Store (Amazon EBS) Container Storage Interface
(CSI) driver:* For installation and upgrade information, see
link:eks/latest/userguide/managing-ebs-csi.html[Managing
the Amazon EBS CSI driver as an Amazon EKS add-on,type="documentation"].
* *Amazon Elastic File System (Amazon EFS) Container Storage Interface
(CSI) driver:* For installation and upgrade information, see
link:eks/latest/userguide/efs-csi.html[Amazon EFS
CSI driver,type="documentation"].
...
link:eks/latest/userguide/eks-add-ons.html[Learn
more about what components are available as EKS Add-ons&#44; and how to
get started.,type="documentation"]
...
link:eks/latest/userguide/cluster-insights.html[Cluster
Insights,type="documentation"] is a feature that provides findings on issues that may impact
...
link:eks/latest/userguide/cluster-insights.html[Official
EKS Docs,type="documentation"] *
...
* events in the
link:eks/latest/userguide/control-plane-logs.html[audit
logs,type="documentation"] with `k8s.io/deprecated` set to `true`:
...
supported across
link:eks/latest/userguide/fargate.html[AWS
Fargate,type="documentation"],
link:eks/latest/userguide/managed-node-groups.html[managed
node groups,type="documentation"], and
link:eks/latest/userguide/worker.html[self-managed
nodes,type="documentation"]. We highly recommend keeping your
link:eks/latest/userguide/eks-optimized-amis.html[Amazon
Machine Image (AMI),type="documentation"] versions up-to-date for security reasons. Older
...
AWS published a
link:eks/latest/userguide/pod-security-policy-removal-faq.html[detailed
FAQ in the EKS documentation.,type="documentation"]
...
the link:eks/latest/userguide/ebs-csi.html[Amazon
EBS CSI driver,type="documentation"] before updating your cluster to version `1.23` to
avoid service interruption.

Review the
link:eks/latest/userguide/ebs-csi-migration-faq.html[Amazon
EBS CSI migration frequently asked questions,type="documentation"].
