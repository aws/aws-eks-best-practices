...
link:#upgrade-add-ons-and-components-using-the-kubernetes-api[other
add-ons.] You must validate and plan upgrades for workloads running on
...
more complicated, and has a higher risk of downtime. In this situation,
link:#evaluate-bluegreen-clusters-as-an-alternative-to-in-place-cluster-upgrades[evaluate
a blue/green cluster upgrade strategy.]
...
[arabic]
. link:#use-the-eks-documentation-to-create-an-upgrade-checklist[Review
the Kubernetes and EKS release notes.]
. link:#backup-the-cluster-before-upgrading[Take a backup of the
cluster. (optional)]
. link:#identify-and-remediate-removed-api-usage-before-upgrading-the-control-plane[Identify
and remediate deprecated and removed API usage in your workloads.]
. link:#track-the-version-skew-of-nodes-ensure-managed-node-groups-are-on-the-same-version-as-the-control-plane-before-upgrading[Ensure
...
. link:#upgrade-add-ons-and-components-using-the-kubernetes-api[Review
...
link:#enable-node-expiry-for-karpenter-managed-nodes[Karpenter also
