...
Amazon Elastic Kubernetes Service (Amazon EKS) version rollback gives you the ability to revert your cluster's Kubernetes control plane to the previous minor version within 7 days of an in-place upgrade. This page describes best practices for planning, executing, and operationalizing rollback as part of your upgrade workflow.
