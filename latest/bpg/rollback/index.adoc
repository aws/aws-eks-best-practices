...
[abstract]
--
Best practices for planning, executing, and operationalizing Amazon EKS cluster version rollback.
--
...
For complete Auto Mode rollback procedures and the `CancelUpdate` operation, see https://docs.aws.amazon.com/eks/latest/userguide/rollback-automode-nodes.html[Roll back Amazon EKS Auto Mode clusters].
...
* https://docs.aws.amazon.com/eks/latest/userguide/rollback-automode-nodes.html[Roll back Amazon EKS Auto Mode clusters]
