...
[NOTE]
====
For more information on how API A&F works please see the following https://docs.aws.amazon.com/eks/latest/best-practices/scale-control-plane.html#_api_priority_and_fairness[best practices guide]
====
...
For more information, visit https://docs.aws.amazon.com/eks/latest/best-practices/scale-control-plane.html#_api_priority_and_fairness[API Priority and Fairness settings] in the EKS Best Practices Guide.
