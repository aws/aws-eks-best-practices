...
If you are using CloudWatch and CloudWatch Logs you can add agent filtering using patterns link:AmazonCloudWatch/latest/logs/FilterAndPatternSyntax.html[described in the documentation,type="documentation"].
