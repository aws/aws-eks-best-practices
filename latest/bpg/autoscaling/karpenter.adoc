...
best practice
https://docs.aws.amazon.com/eks/latest/best-practices/application.html#_recommendations[recommendations].
See
...
See
https://docs.aws.amazon.com/eks/latest/best-practices/data-plane.html#_recommendations[Configure
...
https://docs.aws.amazon.com/eks/latest/best-practices/scale-cluster-services.html#_coredns_lameduck_duration[CoreDNS
lameduck duration]

https://docs.aws.amazon.com/eks/latest/best-practices/scale-cluster-services.html#_coredns_readiness_probe[CoreDNS
readiness probe]
