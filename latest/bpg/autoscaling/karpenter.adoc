...
link:autoscaling/ec2/userguide/AutoScalingGroup.html[Amazon
EC2 Auto Scaling groups,type="documentation"] and the
...
Node Groups,type="documentation"] (MNGs). ASGs and MNGs are AWS-native abstractions where
scaling is triggered based on AWS level metrics, such as EC2 CPU load.
link:eks/latest/userguide/autoscaling.html#cluster-autoscaler[Cluster
Autoscaler,type="documentation"] bridges the Kubernetes abstractions into AWS abstractions,
...
link:eks/latest/userguide/private-clusters.html#private-cluster-requirements[requirements,type="documentation"]
...
link:awsaccountbilling/latest/aboutv2/using-pelong.html[Price
List Query API,type="documentation"]_*. As a result, pricing data will go stale over time.
...
link:AWSEC2/latest/UserGuide/ec2-fleet-allocation-strategy.html[Price
Capacity Optimized,type="documentation"] allocation strategy to provision EC2 instances. This
...
best practice
link:eks/latest/best-practices/application.html#_recommendations[recommendations,type="documentation"].
See
...
link:AmazonCloudWatch/latest/logs/MonitoringLogData.html[metrics
filter,type="documentation"] to look for specific patterns or terms in your logs and then
create a
link:AmazonCloudWatch/latest/monitoring/AlarmThatSendsEmail.html[CloudWatch
alarm,type="documentation"] to alert you when your configured metrics threshold is breached.
...
found in the
link:cost-management/latest/userguide/getting-started-ad.html[AWS
Cost Anomaly Detection Getting Started,type="documentation"] guide. If you've gone so far as
...
link:cost-management/latest/userguide/budgets-controls.html[Configuring
AWS Budgets actions,type="documentation"].
...
See
link:eks/latest/best-practices/data-plane.html#_recommendations[Configure
and Size Resource Requests/Limits for all Workloads,type="documentation"]
...
link:eks/latest/best-practices/scale-cluster-services.html#_coredns_lameduck_duration[CoreDNS
lameduck duration,type="documentation"]

link:eks/latest/best-practices/scale-cluster-services.html#_coredns_readiness_probe[CoreDNS
readiness probe,type="documentation"]
