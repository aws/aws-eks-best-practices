...
----
include::iam_snippet:8766d860-1b5c-4664-a60d-063f2985a4f6[]
----
...
|max-scale-down-parallelism |Maximum number of nodes (both empty and
needing drain) that can be deleted in parallel. Cluster Autoscaler
v1.32.0 deprecated `--max-empty-bulk-delete` and replaced it with
`--max-scale-down-parallelism`. If you use a Cluster Autoscaler
version earlier than v1.32.0, use `--max-empty-bulk-delete` instead. |10
