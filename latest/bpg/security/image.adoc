...
report are then
https://github.com/sigstore/cosign/blob/main/doc/cosign_attest.md[attested
...
* https://docs.snyk.io/developer-tools/snyk-cli/snyk-cli/scan-and-maintain-projects-using-the-cli/snyk-cli-for-snyk-container[Snyk]
...
can be used to
https://kyverno.io/docs/policy-types/cluster-policy/verify-images/sigstore/[verify
attestations].
* Refer to this
...
----
include::iam_snippet:2043a038-0f13-4c00-9cca-2526a893d57a[]
----
