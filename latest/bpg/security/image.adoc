...
* link:inspector[Amazon Inspector,type="documentation"] can be used to
link:inspector/latest/user/sbom-export.html[create
and export SBOMs,type="documentation"].
...
link:AmazonECR/latest/userguide/image-scanning.html[two
types of scanning - Basic and Enhanced,type="documentation"]. Basic scanning leverages
https://github.com/quay/clair[Clair] an open source image scanning
solution for no cost.
link:AmazonECR/latest/userguide/image-scanning-enhanced.html[Enhanced
scanning,type="documentation"] uses Amazon Inspector to provide automatic continuous scans
...
link:signer/latest/developerguide/Welcome.html[AWS
Signer,type="documentation"] or
...
link:AmazonECR/latest/userguide/Repositories.html#repository-concepts[namespaces,type="documentation"].
...
link:AmazonECR/latest/userguide/vpc-endpoints.html[Amazon
ECR interface VPC endpoints,type="documentation"].
...
See,
link:IAM/latest/UserGuide/reference_policies_condition-keys.html#condition-keys-principalorgid[aws:PrincipalOrgID,type="documentation"]
...
link:AmazonECR/latest/userguide/LifecyclePolicies.html[AWS
official documentation,type="documentation"] describes how to set up test rules, evaluate
them and then apply them. There are several
link:AmazonECR/latest/userguide/lifecycle_policy_examples.html[lifecycle
policy examples,type="documentation"] in the official docs that show different ways of
...
We can use
link:signer/latest/developerguide/Welcome.html[AWS
Signer,type="documentation"] or https://github.com/sigstore/cosign[Sigstore Cosign], to sign
