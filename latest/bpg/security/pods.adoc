...
outlined in a
https://kyverno.io/blog/2023/05/24/psp-migration/[blog
...
https://kyverno.io/docs/policy-types/cluster-policy/autogen/[auto-gen] policies for
...
https://kyverno.io/docs/policy-types/cluster-policy/generate/[Generate Rules].)
