...
https://docs.tigera.io/calico/latest/about/[Calico], is an open source
...
* https://www.inspektor-gadget.io/docs/latest/gadgets/advise_networkpolicy[Inspektor
...
----
include::iam_snippet:6ab440ae-ea51-4955-bc36-a6be567588dc[]
----
