...
* Network Security
* Multi-tenancy
* AWS account and cluster architecture
...
include::automode.adoc[leveloffset=+1]
...
include::account-cluster-architecture.adoc[leveloffset=+1]

include::multiaccount.adoc[leveloffset=+1]

include::cam.adoc[leveloffset=+1]

include::scp.adoc[leveloffset=+1]
