...
link:whitepapers/latest/organizing-your-aws-environment/organizing-your-aws-environment.html[multi
account strategy,type="documentation"] and AWS organizations to help isolate and manage your
business applications and data. There are
link:whitepapers/latest/organizing-your-aws-environment/benefits-of-using-multiple-aws-accounts.html[many
benefits,type="documentation"] to using a multi account strategy:
...
link:whitepapers/latest/organizing-your-aws-environment/benefits-of-using-multiple-aws-accounts.html#group-workloads-based-on-business-purpose-and-ownership[AWS
Multi Account Strategy Whitepaper,type="documentation"]
...
link:whitepapers/latest/organizing-your-aws-environment/organizing-workload-oriented-ous.html[More
information,type="documentation"] is available in this AWS whitepaper.
...
link:eks/latest/userguide/iam-roles-for-service-accounts.html[IAM
roles for Service Accounts (IRSA),type="documentation"] or
link:eks/latest/userguide/pod-identities.html[EKS
Pod Identities,type="documentation"] to deliver temporary AWS credentials and
...
If
link:ram/latest/userguide/getting-started-sharing.html#getting-started-sharing-orgs[RAM
is enabled for your AWS Organization,type="documentation"], you can share the VPC Subnets
...
link:eks/latest/userguide/service-accounts.html#service-accounts-iam[EKS
documentation,type="documentation"] for an in-depth comparison.

===== Accessing AWS API Resources with IAM Roles For Service Accounts

link:eks/latest/userguide/iam-roles-for-service-accounts.html[IAM
Roles for Service Accounts (IRSA),type="documentation"] allows you to deliver temporary AWS
...
link:eks/latest/userguide/enable-iam-roles-for-service-accounts.html[IRSA,type="documentation"],
...
link:eks/latest/userguide/associate-service-account-role.html[follow
the same steps as the documentation,type="documentation"], but use the
link:eks/latest/userguide/cross-account-access.html[12
digit account id of the workload account,type="documentation"] as mentioned in the section
...
link:eks/latest/userguide/pod-identities.html[EKS
Pod Identities,type="documentation"] is a new way of delivering AWS credentials to your
...
perform
link:IAM/latest/UserGuide/id_roles_terms-and-concepts.html#iam-term-role-chaining[Role
Chaining,type="documentation"].

Role chaining can be configured in an applications profile with their
aws configuration file using the
link:sdkref/latest/guide/feature-process-credentials.html[Process
Credentials Provider,type="documentation"] available in various AWS SDKs.
...
link:eks/latest/userguide/pod-id-abac.html[EKS
specific attributes,type="documentation"] as session tags and use attribute based access
...
roles for Service Accounts (IRSA),type="documentation"] or
link:eks/latest/userguide/pod-identities.html[EKS
Pod Identities,type="documentation"] in each account to allow your EKS workloads to get
...
link:eks/latest/userguide/iam-roles-for-service-accounts.html[IAM
roles for Service Accounts,type="documentation"] documentation on how to setup in each
workload for IRSA, and
link:eks/latest/userguide/pod-identities.html[EKS
Pod Identities,type="documentation"] documentation on how to setup EKS pod identities in each
account.
