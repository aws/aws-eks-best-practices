...
Kubernetes:
link:AWSEC2/latest/UserGuide/AmazonEBS.html[EBS,type="documentation"],
link:AWSEC2/latest/UserGuide/AmazonEFS.html[EFS,type="documentation"],
and link:fsx/latest/LustreGuide/what-is.html[FSx
for Lustre,type="documentation"]. All three offer encryption at rest using a service managed
...
refer to
link:efs/latest/ug/encryption-at-rest.html[Encrypting
Data at Rest,type="documentation"]. Besides offering at-rest encryption, EFS and FSx for
...
link:kms/latest/developerguide/rotate-keys.html[Rotating
customer master keys,type="documentation"]
...
encrypted with
link:AWSEC2/latest/UserGuide/EBSEncryption.html[EBS
encryption,type="documentation"]. A pod can retrieve a Kubernetes secrets objects by
...
CSI Driver]
* link:secretsmanager/latest/userguide/integrating_csi_driver.html[Integrating
Secrets Manager secrets with Kubernetes Secrets Store CSI Driver,type="documentation"]
