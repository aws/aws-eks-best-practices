...
Amazon EC2 Spot Instances offer significant cost savings for training workloads (see https://github.com/aws/aws-eks-best-practices/blob/mainline/latest/bpg/aiml/aiml_compute.adoc#consider-using-amazon-ec2-spot-instances-for-gpus-with-karpenter[this section]
