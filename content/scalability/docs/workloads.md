...
A very common question is why the clusters have different latency. It is usually caused by the different volumes of API
requests. You can run the following CloudWatch LogInsight query to understand the difference.
