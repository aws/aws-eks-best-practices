...
The Kubernetes control plane which runs in EKS managed account communicates to worker nodes via the x-ENIs for exec/logs functions. Please refer to the EKS user guide for complete [VPC and subnet requirement](https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html#network-requirements-subnets) details. 
