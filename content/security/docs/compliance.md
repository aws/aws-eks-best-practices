...
## Use AWS Audit Manager and AWS Artifact to simplify and accelerate your compliance
+ [AWS Audit Manager](https://aws.amazon.com/audit-manager/) helps you continuously audit your AWS usage to simplify how you manage risk and compliance with regulations and industry standards. For more information on compliance resources for EKS workloads, visit [Compliance validation for Amazon Elastic Kubernetes Service](https://docs.aws.amazon.com/eks/latest/userguide/compliance.html)
+ [AWS Artifact](https://aws.amazon.com/artifact/) is a go-to, central resource for compliance-related information that matters to you. It provides on-demand access to security and compliance reports from AWS and ISVs who sell their products on AWS Marketplace. Find auditor-issued reports, certifications, accreditations, and other third-party attestations of AWS in a comprehensive resource. Review, accept, and manage your agreements with AWS and apply them to current and future accounts within your organization.Perform due-diligence of ISVs that sell products on AWS Marketplace, with on-demand access to their security and compliance reports.
