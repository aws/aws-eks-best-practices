...
!!! important
If you use SGs for pods you **must** create a SGs that allow port 53 outbound to the to the cluster security group where CoreDNS resides.  Similarly, you **must** update the cluster security group to accept port 53 inbound traffic from the pod security group.  
